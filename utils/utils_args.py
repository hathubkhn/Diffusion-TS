...
def parse_args_cond():
    ...
    parser.add_argument('--num_cross', type=int, default=8,
                    help='Num heads of cross attention')
    # --- data ---
...
#     # parser.add_argument('--num_heads', type=int,default = 4, help='number of head of attention')
