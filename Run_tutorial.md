...
8. run: python run_conditional.py --config ./configs/extrapolation/goog.yaml --seed 2024
python run_conditional.py --config ./configs/extrapolation/xom.yaml --seed 2024