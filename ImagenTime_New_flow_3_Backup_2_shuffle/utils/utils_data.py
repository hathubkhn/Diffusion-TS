...
def gen_dataloader(args):
    if args.dataset == 'sine':
        ...
        reference = f"/home/user11/thongt/ImagenTime_New_flow_3_Backup_2/ENCODE_IMAGE_UNET/{args.run_type}/ViT-B-32/{args.symbols}/{args.convert_method}/{args.seq_len}/{args.top_k}_{args.step_sizes}.pt" #{args.model_name}, {args.convert_method}, {args.step_sizes}
